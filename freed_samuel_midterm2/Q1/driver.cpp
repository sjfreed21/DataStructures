...
// This test case was added in order to test the deletion of a left child of the right tree.
cout<<"------------Creating tree - test-4------------"<<endl;
  BST tree_4;
  int numbers_4[] = {10, 15, 11, 19};
  for(int i = 0; i < 4; i++) {
    tree_4.addNode(numbers_4[i]);
  }

  cout << "before decrement " <<endl;
  tree_4.print2DUtil(1);
  tree_4.decrement();
  tree_4.decrement();
  cout << "after decrement() 2 times " <<endl;
  tree_4.print2DUtil(1);
